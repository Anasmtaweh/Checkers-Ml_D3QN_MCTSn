...
AZ_MODEL_PATH = os.path.join(
    PROJECT_ROOT, "mcts_workspace/checkpoints/alphazero/checkpoint_iter_237.pth"
)
...
def run_benchmark():
    ...
    for i in range(MATCHES):
        ...
        while not env.done:
            is_az_turn = (env.current_player == 1 and az_is_p1) or (
                env.current_player == -1 and not az_is_p1
            )
