"""
Round-robin evaluation across multiple D3QN checkpoints.

Usage:
  python -m training.d3qn.tournament_eval --checkpoints models/d3qn/best_model.pt,models/d3qn/final.pt --episodes 20
"""
...
from training.d3qn import evaluate_d3qn_vs_ddqn
