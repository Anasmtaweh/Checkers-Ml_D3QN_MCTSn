"""
Utilities for evaluating a D3QN checkpoint across multiple random seeds.
"""
...
from training.d3qn.evaluation import evaluate_d3qn_vs_random
...
def evaluate_checkpoint_multi_seed(
    ...
    """
    Evaluate a D3QN checkpoint over multiple random seeds and aggregate statistics.
    """
    ...
    for i in range(num_seeds):
        ...
        win_rates.append(stats.get("overall_win_rate", 0.0))
...
def _main():
    parser = argparse.ArgumentParser(description="Multi-seed evaluation for D3QN checkpoints")
    parser.add_argument("--checkpoint", type=str, required=True, help="Path to D3QN checkpoint")
